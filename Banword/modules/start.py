...
START_BUTTONS = InlineKeyboardMarkup([
    ...
    [
        InlineKeyboardButton("• ʟᴏɢs •", url="https://t.me/snowy_hometown"),
        InlineKeyboardButton("• ᴜᴘᴅᴀᴛᴇ •", url="https://t.me/dark_musictm")
    ],
    [InlineKeyboardButton("🥀 ᴅᴇᴠᴇʟᴏᴩᴇʀ 🥀", url="https://t.me/uchiha_owner")]
])
